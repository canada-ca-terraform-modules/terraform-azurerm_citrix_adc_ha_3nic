...
module "SRV-CTXADC" {
  ...
  nic1_subnetName         = data.azurerm_subnet.PROJ_RZ-snet.name                  # MGMT
  nic2_subnetName         = data.azurerm_subnet.PROJ_PAZ-snet.name                 # Client
  nic3_subnetName         = data.azurerm_subnet.PROJ_OZ-snet.name                  # Server
  nic_vnetName            = data.azurerm_subnet.PROJ_PAZ-snet.virtual_network_name # same name for all 3 subnets
  nic_resource_group_name = data.azurerm_subnet.PROJ_PAZ-snet.resource_group_name  # same name for all 3 subnets
  ...
  nic2_ip_configuration = {
    private_ip_address1           = local.SRV-CTXADC1-PAZ
    private_ip_address2           = local.SRV-CTXADC2-PAZ
    private_ip_address_allocation = "Static"
  }
  nic3_ip_configuration = {
    private_ip_address1           = local.SRV-CTXADC1-OZ
    private_ip_address2           = local.SRV-CTXADC2-OZ
    private_ip_address_allocation = "Static"
  }
  lb_private_ip = local.SRV-CTXADCLB
  vm_size       = var.vm_configs.SRV-CTXADC.vm_size
  tags          = var.tags
}
```
