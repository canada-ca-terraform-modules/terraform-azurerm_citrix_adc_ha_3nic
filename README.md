...
| lb_private_ip                           | string | yes       | Static IP for the internal load balancer |
| public_ip                               | bool   | no       | Does the Cluster require a public IP. true or false. Default: false                                                                                                                                              |
| storage_image_reference                 | object | no       | Specify the storage image used to create the VM. Default is citrix-adc-13. - [storage image](#storage-image-reference-object)                                                                             |
